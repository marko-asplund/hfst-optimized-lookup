 ...
 * interfaces to them.
 */
public class Transducer implements HfstOptimizedLookup.transducer
{
    ...
    public Transducer(FileInputStream file, TransducerHeader h, TransducerAlphabet a) throws java.io.IOException
    {
	header = h;
	alphabet = a;
